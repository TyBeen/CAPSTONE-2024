...
try {
  ...
  exports.forgotPassword = async (req, res) => {
    try {
      ...
      <a href="https://capstoneportal.netlify.app/resetPassword?token=${token}">https://capstoneportal.netlify.app/resetPassword/?token=${token}</a>
  ...
  exports.deleteUser = async (req, res) => {
    if (req.user.isAdmin || req.user._id === req.params._id) {
      ...
      res
        .status(400)
        .json("You do not have authorization to delete this user.");
    }
  };
